...
The container ships Node 24 (dev) resp. Node 26 (production image) + pnpm 10.33.3, forwards ports `5005/5006/5007` and sets recommended VS Code
...
- Node 24+ (production image: Node 26) / TypeScript / pnpm 10
